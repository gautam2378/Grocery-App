...
const routes: Routes = [
  ...
  {
    path:"Top-5-Product",
    component:AdminViewTop5sellingProductsComponent,canActivate: [AuthGuard] 
  },

  {
    path:"My_Cart/:id",
    component:UserCartComponent,canActivate: [AuthGuard] 
  },
  {
    path: "Product-user-view/:id",
    component: ProductUserViewComponent,canActivate: [AuthGuard] 
  },
  {
  ...
  { path: '', redirectTo: '/Register', pathMatch: 'full' },
  {
    ...
    {
      path:"Recent-Orders",
      component: AdminViewRecentOrdersComponent,canActivate: [AuthGuard] 
    },
    {
      path:"Top-5-Product",
      component:AdminViewTop5sellingProductsComponent,canActivate: [AuthGuard] 
